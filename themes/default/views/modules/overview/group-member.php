            ...
            <table id="member-list" class="table display">
                ...
                <?php for($i=0; $i<count($all_anggota_majelis_per_investor); $i++) {?>
                    <tr>
                        ...
                        <td><?php echo '<a href="'.site_url('overview/member').'/'.$all_anggota_majelis_per_investor[$i]->client_id.'" target="">'
                                       .$all_anggota_majelis_per_investor[$i]->client_fullname.'</a>'; ?></td>
